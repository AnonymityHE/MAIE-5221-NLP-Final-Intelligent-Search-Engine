...
- **Week 4:** Project Kick-off and Team Formation (Done)
- **Week 4:** Release of Test Set 1. (Done)
...
1. **Accuracy:** The relevance and correctness of the returned results.
2. **Search Time:** The overall latency of the system, from query submission to result presentation. You must comprehensively optimize your system for both speed and accuracy.
3. No Web UI is needed. You can just run the system in command lines. However, if you want to implement the web UI, it is extremely good.

## **5. Team Formation**

You will form teams of **3-4 members**. Teamwork and collaboration are essential for a project of this scale. Please finalize and submit your team registrations by **this Friday**. (Done)

## **6. Getting Started**

1. Form your team and register it by **this Friday**. (Done)
2. Begin brainstorming the high-level architecture of your system.
