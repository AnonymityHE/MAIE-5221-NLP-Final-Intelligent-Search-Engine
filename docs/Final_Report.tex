...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{visualizations/latency_breakdown.png}
\caption{Response Latency Breakdown by Component}
\label{fig:latency}
\end{figure}

Figure \ref{fig:latency} shows the latency distribution across system components. LLM inference dominates total response time, accounting for approximately 70\% of end-to-end latency.
