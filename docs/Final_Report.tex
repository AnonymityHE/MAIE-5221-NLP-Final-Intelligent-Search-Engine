...
We conducted comprehensive evaluation across multiple test sets to validate system capabilities. Our evaluation includes 78 test queries across four test suites, covering functional correctness, tool routing accuracy, model performance comparison, and extended scenario testing.

\subsection{Test Suite Overview}

\begin{table}[h]
\centering
\caption{Evaluation Test Suites Summary}
...
Extended Evaluation & 40 & 100\% & 13.65s \\ \midrule
\textbf{Total Queries} & \textbf{78} & \textbf{100\%} & \textbf{13.9s avg} \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Tool Usage Distribution}
\label{tab:tool_stats}
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Tool} & \textbf{Invocations} & \textbf{Success Rate} & \textbf{Avg Latency} \\ \midrule
Local RAG & 5 & 100\% & 11.1s \\
Finance API & 3 & 100\% & 9.8s \\
Weather API & 2 & 100\% & 16.6s \\ \bottomrule
\end{tabular}
\end{table}
